...
- **A**: [query_A.md](code/result_logs/query_A.md)
- **I**: [query_I.md](code/result_logs/query_I.md)
- **J**: [query_J.md](code/result_logs/query_J.md)
- **K**: [query_K.md](code/result_logs/query_K.md)
- **hello**: [query_hello.md](code/result_logs/query_hello.md)
- **parallel fan-out**: [query_fan_out.md](code/result_logs/query_fan_out.md)
- **critic verdict**: [query_critic](code/result_logs/query_critic)
- **coder skill**: [query_coder.md](code/result_logs/query_coder.md)
- **translation skill**: [query_translator.md](code/result_logs/query_translator.md)
